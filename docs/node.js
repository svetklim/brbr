...
;
	($.$brbr_brbr_logo_demo) = class $brbr_brbr_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$brbr_brbr_logo_demo.prototype), "Logo"));
...
;
	($.$brbr_brbr_button_demo) = class $brbr_brbr_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$brbr_brbr_button_demo.prototype), "Login"));
	($mol_mem(($.$brbr_brbr_button_demo.prototype), "Logout"));
...
;
	($.$brbr_brbr_docs) = class $brbr_brbr_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
