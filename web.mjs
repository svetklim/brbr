...
;
	($.$brbr_brbr_logo) = class $brbr_brbr_logo extends ($.$mol_icon_molecule) {};
...
var $;
(function ($) {
    $mol_style_attach("brbr/brbr/logo/logo.view.css", "[brbr_brbr_logo] {\n\tanimation: rotate 4s infinite;\n}\n\n@keyframes rotate {\n\t0% {\n\t\ttransform: rotate(0deg)\n\t}\n\n\t100% {\n\t\ttransform: rotate(360deg)\n\t}\n}\n");
})($ || ($ = {}));
...
;
	($.$brbr_brbr_button) = class $brbr_brbr_button extends ($.$mol_button_major) {};
...
;
	($.$brbr_brbr_app) = class $brbr_brbr_app extends ($.$mol_book2_catalog) {
		Logo2(){
			const obj = new this.$.$brbr_brbr_logo();
			return obj;
		}
		Theme(){
		...
		Logout_button(){
			const obj = new this.$.$brbr_brbr_button();
			(obj.title) = () => ("Выйти");
			return obj;
		}
		Docs_uri(){
			...
			(obj.uri) = () => ("http://localhost:9080/brbr/brbr/docs/-/test.html");
			return obj;
		}
		Docs(){
			const obj = new this.$.$mol_page();
	...
	($mol_mem(($.$brbr_brbr_app.prototype), "Logo2"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Theme"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Sources"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Lighter"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Logout_button"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Docs_uri"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Docs"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Hello"));
	($mol_mem(($.$brbr_brbr_app.prototype), "Page1"));
